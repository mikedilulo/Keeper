<template>
  <div class="contactform">
    <form class="contact-form" id="myform" method="POST" @submit="sendEmail">
      ...
      <br />
      <br />
      <button class="btn btn-danger btn-sm" type="submit">Send Email</button>
    </form>
  </div>
</template>
...
export default {
  ...
  methods: {
    sendEmail(event) {
      ...
      var template_id = "template_dwKk2nr8";
